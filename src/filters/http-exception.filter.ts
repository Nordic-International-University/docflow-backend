...
const ERROR_TRANSLATIONS: Record<string, string> = {
  ...
  'Invalid or expired refresh token':
    'Yangilash tokeni yaroqsiz yoki muddati tugagan',
  'User account is inactive or deleted':
    "Foydalanuvchi hisobi faol emas yoki o'chirilgan",
  ...
  'Tags are required when using a template':
    'Shablon ishlatilganda teglar kiritilishi shart',
  ...
  'You can only create documents with journals from your own department':
    "Faqat o'z bo'limingiz jurnalidan hujjat yaratishingiz mumkin",
  ...
  'Workflow already exists for this document':
    'Bu hujjat uchun ish jarayoni allaqachon mavjud',
  'Workflow template has no steps defined':
    'Ish jarayoni shablonida bosqichlar belgilanmagan',
  ...
  'User ID is required to reject a step':
    'Bosqichni rad etish uchun foydalanuvchi ID si kerak',
  'Rollback user not found': 'Qaytarish foydalanuvchisi topilmadi',
  'Step orders must be unique':
    'Bosqich tartib raqamlari takrorlanmasligi kerak',
  'Assigned user not found': 'Tayinlangan foydalanuvchi topilmadi',
  'One or more assigned users not found':
    'Bir yoki bir nechta tayinlangan foydalanuvchi topilmadi',
  'One or more assigned roles not found':
    'Bir yoki bir nechta tayinlangan rol topilmadi',
  ...
  'User is already a member of this project':
    "Foydalanuvchi allaqachon bu loyiha a'zosi",

  // ==================== PROJECT LABEL ====================
  'Project label not found': "Loyiha yorlig'i topilmadi",
  'Label name must be unique within project':
    'Yorliq nomi loyiha ichida takrorlanmasligi kerak',
  ...
  'Target column not found in this project':
    'Bu loyihada maqsad ustun topilmadi',

  // ==================== TASK ====================
  'Task not found': 'Topshiriq topilmadi',
  'Task category not found': 'Topshiriq kategoriyasi topilmadi',
  'Task category name must be unique':
    'Topshiriq kategoriyasi nomi takrorlanmasligi kerak',
  ...
  'This attachment is already linked to the task':
    'Bu fayl allaqachon topshiriqqa biriktirilgan',
  ...
  'User is already watching this task':
    'Foydalanuvchi allaqachon bu topshiriqni kuzatmoqda',
  ...
  'Label is already assigned to this task':
    'Yorliq allaqachon bu topshiriqqa biriktirilgan',
  ...
  'minScore cannot be greater than maxScore':
    "Minimal ball maksimal balldan katta bo'la olmaydi",
  ...
  'Document is not approved. Only approved documents can be downloaded.':
    'Hujjat tasdiqlanmagan. Faqat tasdiqlangan hujjatlarni yuklab olish mumkin.',
  'You do not have permission to download this document':
    'Siz bu hujjatni yuklab olish huquqiga ega emassiz',
  ...
  'Document template with this name already exists':
    'Bu nomdagi hujjat shabloni allaqachon mavjud',
  'Cannot delete template that is being used by documents':
    "Hujjatlar tomonidan ishlatiladigan shablonni o'chirib bo'lmaydi",

  // ==================== WORKFLOW (qo'shimcha) ====================
  'Workflow template not found or is inactive':
    'Ish jarayoni shabloni topilmadi yoki faol emas',
  'Either workflowTemplateId or steps must be provided':
    "workflowTemplateId yoki bosqichlar ko'rsatilishi kerak",
  'Step with the specified order does not exist':
    "Ko'rsatilgan tartib raqamli bosqich mavjud emas",
  'Workflow template with this name already exists':
    'Bu nomdagi ish jarayoni shabloni allaqachon mavjud',
  'One or more assigned departments not found':
    "Bir yoki bir nechta tayinlangan bo'lim topilmadi",

  // ==================== WORKFLOW STEP (qo'shimcha) ====================
  'This workflow has been completed and cannot be modified':
    "Bu ish jarayoni yakunlangan va o'zgartirib bo'lmaydi",
  'Only the workflow creator can add workflow steps':
    "Faqat ish jarayoni yaratuvchisi bosqich qo'sha oladi",
  'Only the workflow creator can update workflow steps':
    'Faqat ish jarayoni yaratuvchisi bosqichni yangilay oladi',
  'Only the workflow creator can delete workflow steps':
    "Faqat ish jarayoni yaratuvchisi bosqichni o'chira oladi",
  'Only the workflow creator can reassign workflow steps':
    'Faqat ish jarayoni yaratuvchisi bosqichni qayta tayinlay oladi',
  'A step with this order already exists in the workflow':
    'Bu tartib raqamli bosqich allaqachon ish jarayonida mavjud',
  'VERIFICATION type workflow steps cannot be reassigned. They must be completed by the originally assigned user.':
    "TEKSHIRUV turidagi bosqichlarni qayta tayinlab bo'lmaydi. Ular dastlab tayinlangan foydalanuvchi tomonidan bajarilishi kerak.",
  'VERIFICATION type workflow steps cannot be rejected or rolled back. They can only be completed with file attachments.':
    "TEKSHIRUV turidagi bosqichlarni rad etib yoki qaytarib bo'lmaydi. Ular faqat fayl biriktirish orqali yakunlanadi.",
  'Cannot complete this step. Current workflow step is':
    "Bu bosqichni yakunlab bo'lmaydi. Bosqichlar tartib bo'yicha yakunlanishi kerak.",
  'Cannot reject this step. Current workflow step is':
    "Bu bosqichni rad etib bo'lmaydi. Bosqichlar tartib bo'yicha qayta ishlanishi kerak.",
  'Creator step not found in this workflow. Unable to reject to creator.':
    "Yaratuvchi bosqichi topilmadi. Yaratuvchiga qaytarib bo'lmaydi.",
  'Rollback feature is only available for CONSECUTIVE workflows':
    'Qaytarish funksiyasi faqat KETMA-KET ish jarayonlari uchun mavjud',
  'Cannot complete': "Bu bosqichni yakunlab bo'lmaydi",
  'At least one file attachment is required for verification steps':
    'Tekshiruv bosqichlari uchun kamida bitta fayl biriktirish talab qilinadi',
  'This endpoint is only for VERIFICATION type workflow steps':
    'Bu endpoint faqat TEKSHIRUV turidagi bosqichlar uchun',

  // ==================== WOPI (qo'shimcha) ====================
  'You do not have permission to edit this document':
    'Siz bu hujjatni tahrirlash huquqiga ega emassiz',
  'You do not have permission to access this document.':
    'Siz bu hujjatga kirish huquqiga ega emassiz',
  'You do not have permission to edit XFDF annotations. Only users with an active workflow step can perform this action.':
    "XFDF annotatsiyalarini tahrirlash huquqingiz yo'q. Faqat faol bosqichga ega foydalanuvchilar bu amalni bajara oladi.",
  'You do not have permission to access this file':
    'Siz bu faylga kirish huquqiga ega emassiz',

  // ==================== TASK DEPENDENCY (qo'shimcha) ====================
  'Both tasks must be in the same project to create a dependency':
    "Bog'liqlik yaratish uchun ikkala topshiriq bir loyihada bo'lishi kerak",
  'Cannot create circular dependency: the blocking task already depends on the dependent task':
    "Davriy bog'liqlik yaratib bo'lmaydi: bloklayotgan topshiriq allaqachon bog'liq topshiriqqa bog'langan",
  'Cannot create dependency: this would create a circular dependency chain':
    "Bog'liqlik yaratib bo'lmaydi: bu davriy bog'liqlik zanjirini hosil qiladi",

  // ==================== TASK (qo'shimcha) ====================
  'Parent task not found or not in same project':
    'Asosiy topshiriq topilmadi yoki boshqa loyihada',
  'Board column not found or not in same project':
    'Ustun topilmadi yoki boshqa loyihada',
  'Label must belong to the same project as the task':
    "Yorliq topshiriq bilan bir loyihaga tegishli bo'lishi kerak",

  // ==================== TASK COMMENT (qo'shimcha) ====================
  'Parent comment not found or does not belong to this task':
    'Asosiy izoh topilmadi yoki bu topshiriqqa tegishli emas',

  // ==================== BOARD (qo'shimcha) ====================
  'Column name must be unique within the project':
    'Ustun nomi loyiha ichida takrorlanmasligi kerak',
  'Cannot delete column with tasks. Move or delete tasks first.':
    "Topshiriqlari bor ustunni o'chirib bo'lmaydi. Avval topshiriqlarni ko'chiring yoki o'chiring.",
  'Some columns were not found or do not belong to this project':
    "Ba'zi ustunlar topilmadi yoki bu loyihaga tegishli emas",

  // ==================== DEPARTMENT (qo'shimcha) ====================
  'This user is already assigned as a director of another department':
    "Bu foydalanuvchi allaqachon boshqa bo'lim direktori etib tayinlangan",

  // ==================== ATTACHMENT (qo'shimcha) ====================
  'Attachment with same file name and URL already exists':
    'Bir xil fayl nomi va URL bilan biriktirma allaqachon mavjud',

  // ==================== USER (qo'shimcha) ====================
  'This Telegram ID is already linked to another account':
    'Bu Telegram ID allaqachon boshqa hisobga ulangan',
  'No Telegram account is linked to this user':
    'Bu foydalanuvchiga Telegram hisob ulanmagan',

  // ==================== KPI (qo'shimcha) ====================
  'Cannot approve reward with status':
    "Bu holat bilan mukofotni tasdiqlab bo'lmaydi",
  'Cannot mark as paid with status':
    "Bu holat bilan to'langan deb belgilab bo'lmaydi",
  'Score range overlaps with existing tier':
    'Ball diapazoni mavjud daraja bilan ustma-ust tushadi',
  'Task score config for priority level':
    'Ushbu ustuvorlik darajasi uchun ball konfiguratsiyasi',

  // ==================== PERMISSION (qo'shimcha) ====================
  'Permission key already used by another permission':
    'Bu ruxsat kaliti boshqa ruxsat tomonidan ishlatilgan',
}
...
function translatePrismaError(
  ...
  switch (code) {
    case 'P2002':
      ...
      if (target?.includes('document_number')) {
        return {
          ...
          message:
            'Bu raqamli hujjat allaqachon mavjud. Iltimos qayta urining.',
        }
      }
    ...
    case 'P2014':
      return {
        status: HttpStatus.BAD_REQUEST,
        message:
          "Bu yozuvni o'chirib bo'lmaydi — unga bog'liq boshqa ma'lumotlar mavjud.",
      }
  ...
  if (
    ...
    return {
      ...
      message:
        "Ma'lumotlar bazasi bilan ishlashda xatolik. Iltimos qayta urining.",
    }
  }
...
export class HttpExceptionFilter implements ExceptionFilter {
  private readonly logger = new Logger('HttpExceptionFilter')
    ...
    // 3. Internal/noma'lum xato — foydalanuvchiga stack trace KO'RSATILMAYDI
      ...
      status = HttpStatus.INTERNAL_SERVER_ERROR
      message =
        'Ichki server xatosi. Iltimos qayta urining yoki administratorga murojaat qiling.'
