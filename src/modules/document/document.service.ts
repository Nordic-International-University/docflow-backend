...
import { Prisma, DocumentStatus, WorkflowStatus } from '@prisma/client'

interface DocumentAttachmentSelect {
  id: string
  fileName: string
  fileUrl: string
  fileSize: number
...
interface DocumentTemplateWithFile {
  id: string
  name: string
  description: string | null
  templateFileId: string
  documentTypeId: string
  requiredTags: Prisma.JsonValue
  isActive: boolean
  isPublic: boolean
  templateFile: {
    id: string
...
export class DocumentService {
  ...
  async documentPublicVerification(documentId: string): Promise<DocumentPublicVerificationResponse> {
    const document = await this.#_prisma.document.findFirst({
      where: {
        id: documentId,
        deletedAt: null,
